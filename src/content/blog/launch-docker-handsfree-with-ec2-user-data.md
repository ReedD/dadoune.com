...
date: 2015-06-20
tags: ["Amazon Web Services", "EC2", "Docker", "Compose"]
---
...
If you don't know how to launch an EC2 instance then you'll need to look up a more detailed tutorial for that. They're all over the place so I won't waste time with it here. But basically the magic happens on step 3 titled _Configure Instance_. Just expand the _Advanced Details_ accordion and paste the snippet in as text. Launch and you're done!
